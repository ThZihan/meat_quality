...
CHART_REFRESH_INTERVAL = 2  # Dashboard refresh interval in seconds
AUTO_REFRESH_ENABLED = True  # Enable automatic dashboard refresh

# Visualization Settings
HISTORY_DISPLAY_COUNT = 100  # Number of readings to display in charts
