# ========================================
# Upload Script for MQ137 Sensor (PowerShell)
# ESP32 NodeMCU - Meat Quality Air Data
# ========================================

Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "MQ137 Ammonia Sensor Upload Script" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
if (-not (Test-Path "src_mq137\platformio.ini")) {
    Write-Host "ERROR: src_mq137\platformio.ini not found!" -ForegroundColor Red
    Write-Host ""
    Read-Host "Press Enter to exit"
    exit 1
}
...
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "About to upload MQ137 sensor code" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Source file: src/main.cpp" -ForegroundColor White
Write-Host "Target: ESP32 NodeMCU (COM7)" -ForegroundColor White
Write-Host ""
Write-Host "Expected output after upload:" -ForegroundColor White
Write-Host "  - MQ137 Ammonia Sensor" -ForegroundColor White
Write-Host "  - Circuit wiring information" -ForegroundColor White
Write-Host "  - NH3 readings" -ForegroundColor White
...
Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Building MQ137 sensor code..." -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
if ($LASTEXITCODE -ne 0) {
    ...
    Write-Host "  4. Check COM port in src_mq137\platformio.ini" -ForegroundColor White
...
Write-Host ""
Write-Host "2. Verify you see MQ137 sensor output" -ForegroundColor White
Write-Host ""
Write-Host "Expected output:" -ForegroundColor White
Write-Host "  ========================================" -ForegroundColor Gray
Write-Host "  MQ137 Ammonia Sensor - ESP32 NodeMCU" -ForegroundColor Gray
Write-Host "  ========================================" -ForegroundColor Gray
Write-Host ""
Write-Host "  CIRCUIT WIRING:" -ForegroundColor Gray
Write-Host "  MQ137 VCC  → 5V" -ForegroundColor Gray
Write-Host "  MQ137 GND  → GND" -ForegroundColor Gray
Write-Host "  ..." -ForegroundColor Gray
Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
